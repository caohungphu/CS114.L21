...
- Input: Lượng phân bón của từng loại phân trên một ![km^2](https://latex.codecogs.com/svg.latex?km^2) (Kiểu số nguyên)
- Output: Sản lượng nông sản (kg) (Kiểu số nguyên)
- Cách thu thập data: 
